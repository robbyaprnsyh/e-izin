        ...
        <ul class="mt-6">
            @if (Auth::user()->hasRole('admin'))
                <li class="relative px-6 py-3">
                    ...
                    <a class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                        ...
                        <svg class="w-5 h-5 {{ Request::is('home') ? 'text-purple-600 dark:text-white' : '' }}"
                        ...
                        <span
                            class="ml-4 {{ Request::is('home') ? 'text-purple-600 dark:text-white' : '' }}">Dashboard</span>
                    </a>
                </li>
            <li class="relative px-6 py-3">
                @if (Request::is('user'))
                ...
                <a class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                    ...
                    <svg class="w-5 h-5 {{ Request::is('user') ? 'text-purple-600 dark:text-white' : '' }}"
                        aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" stroke-linejoin="round"
                        stroke-width="2" viewBox="0 0 24 24" stroke="currentColor" class="size-6">
                        <path stroke-linecap="round" stroke-linejoin="round"
                            d="M17.982 18.725A7.488 7.488 0 0 0 12 15.75a7.488 7.488 0 0 0-5.982 2.975m11.963 0a9 9 0 1 0-11.963 0m11.963 0A8.966 8.966 0 0 1 12 21a8.966 8.966 0 0 1-5.982-2.275M15 9.75a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />
                    </svg>
                    <span class="ml-4 {{ Request::is('user') ? 'text-purple-600 dark:text-white' : '' }}">User</span>
                </a>
            </li>
            <li class="relative px-6 py-3">
                ...
                <a class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                    ...
                    <svg class="w-5 h-5 {{ Request::is('jabatan') ? 'text-purple-600 dark:text-white' : '' }}"
                        aria-hidden="true" fill="none" stroke-linecap="round" stroke-linejoin="round"
                        stroke-width="2" viewBox="0 0 24 24" stroke="currentColor">
                        <path
                    ...
                    <span
                        class="ml-4 {{ Request::is('jabatan') ? 'text-purple-600 dark:text-white' : '' }}">Jabatan</span>
                </a>
            </li>
            <li class="relative px-6 py-3">
                ...
                <a class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                    ...
                    <svg class="w-5 h-5 {{ Request::is('izin/menu') ? 'text-purple-600 dark:text-white' : '' }}"
                        aria-hidden="true" fill="none" stroke-linecap="round" stroke-linejoin="round"
                        stroke-width="1" viewBox="0 0 24 24" stroke="currentColor" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <span
                        class="ml-4 mr-4 {{ Request::is('izin/menu') ? 'text-purple-600 dark:text-white' : '' }}">Approve
                        Izin</span>
            ...
            <li class="relative px-6 py-3">
                ...
                <a class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200 dark:text-gray-100"
                    ...
                    <svg class="w-5 h-5 {{ Request::is('karyawan.index') ? 'text-purple-600' : '' }}"
                        aria-hidden="true" fill="none" stroke-linecap="round" stroke-linejoin="round"
                        stroke-width="2" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round"
                            d="M17.982 18.725A7.488 7.488 0 0 0 12 15.75a7.488 7.488 0 0 0-5.982 2.975m11.963 0a9 9 0 1 0-11.963 0m11.963 0A8.966 8.966 0 0 1 12 21a8.966 8.966 0 0 1-5.982-2.275M15 9.75a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />
                    </svg>
                    <span class="ml-4 {{ Request::is('karyawan.index') ? 'text-purple-600' : '' }}">Profile</span>
                </a>
            </li>
            <li class="relative px-6 py-3">
                @if (Request::is('izin'))
                ...
                <a class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200 dark:text-gray-100"
                    ...
                    <svg class="w-5 h-5 {{ Request::is('izin') ? 'text-purple-600 dark:text-white' : '' }}"
                        aria-hidden="true" fill="none" stroke-linecap="round" stroke-linejoin="round"
                        stroke-width="2" viewBox="0 0 24 24" stroke="currentColor">
                        <path
                            d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-3 7h3m-3 4h3m-6-4h.01M9 16h.01">
                    ...
                    <span class="ml-4 {{ Request::is('izin') ? 'text-purple-600 dark:text-white' : '' }}">Izin</span>
                </a>
            </li>
            @endif
        </ul>
