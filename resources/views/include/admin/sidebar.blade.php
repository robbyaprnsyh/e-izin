<aside class="z-20 hidden w-64 overflow-y-auto bg-white dark:bg-gray-800 md:block flex-shrink-0">
    <div class="py-4 text-gray-500 dark:text-gray-400">
        <a class="text-xl font-bold text-gray-800 dark:text-gray-200 flex justify-start items-start ml-6" href="{{ route('home') }}">
        ...
        <ul class="mt-6">
            <li class="relative px-6 py-3">
                ...
                <a class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                    ...
                    <svg class="w-5 h-5 {{ Request::is('home') ? 'text-black dark:text-white' : '' }}" aria-hidden="true" fill="none"
                    ...
                    <span class="ml-4 {{ Request::is('home') ? 'text-black dark:text-white' : '' }}">Dashboard</span>
                </a>
            </li>
        </ul>
        <ul>
            <li class="relative px-6 py-3">
                ...
                <a class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                    ...
                    <svg class="w-5 h-5 {{ Request::is('user') ? 'text-black dark:text-white' : '' }}" aria-hidden="true"
                    ...
                    <span class="ml-4 {{ Request::is('user') ? 'text-black dark:text-white' : '' }}">User</span>
                </a>
            </li>
        </ul>
        <ul>
            <li class="relative px-6 py-3">
                ...
                <a class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                    ...
                    <svg class="w-5 h-5 {{ Request::is('jabatan') ? 'text-black dark:text-white' : '' }}" aria-hidden="true"
                    ...
                    <span class="ml-4 {{ Request::is('jabatan') ? 'text-black dark:text-white' : '' }}">Jabatan</span>
                </a>
            </li>
        </ul>
        <ul>
            <li class="relative px-6 py-3">
                ...
                <a class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                    ...
                    <svg class="w-5 h-5 {{ Request::is('izin/menu') ? 'text-black dark:text-white' : '' }}" aria-hidden="true"
                    ...
                    <span class="ml-4 mr-4 {{ Request::is('izin/menu') ? 'text-black dark:text-white' : '' }}">Approve Izin</span>
